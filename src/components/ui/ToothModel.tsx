...
// Serve Draco decoder locally instead of fetching from Google CDN (saves ~88KB external request)
useGLTF.setDecoderPath("/draco/");

// Watches the canvas container for size changes and forces R3F to
// re-measure itself. Fixes the "invisible until resize" bug that happens
// when the Canvas mounts inside a zero-size div during Next.js hydration.
function RendererWakeup() {
  ...
  useEffect(() => {
    ...
    // Also force immediately in case the container already has size
